...
<%@ taglib prefix="voting" tagdir="/WEB-INF/tags" %>
        ...
        <div class="row">
            <div class="col-5 offset-3">
                ...
                <form:form class="form-group" modelAttribute="userTo" method="post" action="${register ? 'register' : 'profile'}"
                    ...
                    <voting:inputField labelCode="user.name" name="name"/>
                    <voting:inputField labelCode="user.email" name="email"/>
                    <voting:inputField labelCode="user.password" name="password" inputType="password"/>
